...
FONT_PATH = os.path.join(BASE_DIR, 'assets', 'font', 'myFont.ttf')
...
while run:
    ...
    screen.blit(banners[level - 1], (0, HEIGHT - 220))
    if menu:
        level = 0
        draw_menu()
    if game_over:
